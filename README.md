...
<h4>Fizik Hesaplamaları:</h4> Moment hesabı (Moment = Ağırlık x Uzaklık), hareket hesabı (Hareket = Moment x 0.0002) ile ve ters rotasyon ile oyunun denge sistemi kurulmuştur. <br>
